...
interface Props {
  ...
  /** Page-specific actions (navigation links, clear button) rendered at the end. */
  footer?: ReactNode
}

/**
 * The rendered evaluation report. Shared by the standalone /results page and
 * the side-by-side view on /evaluate, so both stay in sync.
 */
export default function ResultsPanel({ result, footer }: Props) {
